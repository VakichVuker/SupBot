class MessageHelper:
    MESSAGES = {
        ...
        'receiver_not_exist': 'Не найден получатель, вероятно получатель сменил свой @username, если он хочет получить сразу много пряников пусть прожмет /start у меня в чате, после повторите ввод команды',
        ...
        'multipryanik_format': 'Формат команды следующий: \n@имя_бота @имя_получателя 123 write whatever you want',
