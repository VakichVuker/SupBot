...
from Handler import AdminMessageHandler, StartHandler, StatisticHandler, PryanikThrowHandler, ContesterControlHandler, GroupChatHandler
...
if __name__ == "__main__":
    ...
    GroupChatHandler.initialize_handlers(bot_config=bot_config)
